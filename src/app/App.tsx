...
function App() {
  return (
    <>
    <Router basename={process.env.REACT_APP_BASE_PATH || 'undefined'}>
      <header>
        <nav>
          <span className="left">
            ...
            <Link className="left" to={`${process.env.PUBLIC_URL}/schools`}>
              <svg className="icon links" style={{width:'32px',height:'32px'}} viewBox="0 0 24 24">
          ...
          <Link className="right" to={`${process.env.PUBLIC_URL}/about`}>
      ...
      <Switch>
        <Route path={`${process.env.PUBLIC_URL}/schools`}>
          <SchoolsListPage />
        </Route>
        <Route path={`${process.env.PUBLIC_URL}/school/:schoolId`}>
          <SchoolPage />
        </Route>
