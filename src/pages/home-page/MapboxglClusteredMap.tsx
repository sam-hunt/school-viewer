...
const MapboxGLClusteredMap: React.FC<IMapboxGLMapProps> = ({ lat, lng, zoom, width, height, features, onFeatureClick, clusterByProperty }) => {
...
export default MapboxGLClusteredMap;
